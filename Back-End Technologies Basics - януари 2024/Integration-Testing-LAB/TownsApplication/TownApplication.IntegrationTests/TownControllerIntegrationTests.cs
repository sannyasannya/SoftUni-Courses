namespace TownApplication.IntegrationTests
{
    public class TownControllerIntegrationTests
    {
        ...
        //[InlineData(0)]
        //[InlineData(-1)]
        //public void UpdateTown_InvalidPopulation_ShouldThrownArgumentException(int invalidPopulation)
        //{
        //    // Arrange
        //    var townName = "Vidin";
        //    var population = 1000;
        ...
        //    // Assert
        //    var exceprion = Assert.Throws<ArgumentException>(action);
        //    Assert.Equal("Population must be a positive number", exceprion.Message);
        //}
        ...
        public void ListTowns_ShouldReturnTowns()
        {
            ...
            var townToAdd = new List<string> { "Vidin", "Sofia", "Plovdiv", "Varna" };
            ...
            Assert.Equal(townToAdd.Count, allTowns.Count);
