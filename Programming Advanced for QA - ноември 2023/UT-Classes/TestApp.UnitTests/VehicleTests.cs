...
{       
    ...
    public void Test_AddAndGetCatalogue_ReturnsSortedCatalogue()
    {
        ...
        string expected = $"Cars:{Environment.NewLine}Ford: Focus - 120hp" +
            $"{Environment.NewLine}Toyota: Camry - 150hp{Environment.NewLine}" +
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsEmptyCatalogue_WhenOnlyCarsAreGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input = 
        ...
        string expected = $"Cars:{Environment.NewLine}Ford: Focus - 120hp" +
            $"{Environment.NewLine}Toyota: Camry - 150hp{Environment.NewLine}Trucks:";
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsEmptyCatalogue_WhenOnlyTrucksAreGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input =
